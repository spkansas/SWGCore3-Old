...
object_draft_schematic_bio_engineer_creature_creature_nexu = object_draft_schematic_bio_engineer_creature_shared_creature_nexu:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Nexu",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/nexu_deed.iff",

   additionalTemplates = {  }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_nexu, "object/draft_schematic/bio_engineer/creature/creature_nexu.iff")
