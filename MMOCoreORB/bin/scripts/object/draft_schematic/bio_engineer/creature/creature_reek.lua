...
object_draft_schematic_bio_engineer_creature_creature_reek = object_draft_schematic_bio_engineer_creature_shared_creature_reek:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Reek",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/reek_deed.iff",

   additionalTemplates = {   }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_reek, "object/draft_schematic/bio_engineer/creature/creature_reek.iff")
